        ...
        <Modal show={modalState} size='4xl'>
            <Modal.Body className="py-8">
                ...
                <section className="py-20">
                    ...
                    <form action="" className="pt-10 lg:px-32 lg:pt-[70px]">
                        <div className="code-f flex justify-center items-center gap-2 pb-20">
                            {VCode.map((data, i) => (
                                <input
                                    title={`OTP_Code_${i}`}
                                    key={"input_" + i}
                        ...
                        <button onClick={handleSbmit} className={`w-full flex justify-center items-center ${interFont} font-extrabold text-lg text-white px-[30px] py-3 border border-[--foreground-light-orange] rounded-[24px] bg-[--foreground-green] btn-shadow3`}>Confirm</button>
                    </form>
                </section>
            </Modal.Body>
        </Modal>
